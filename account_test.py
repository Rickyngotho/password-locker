...
class TestAccount(unittest.TestCase):
    def setUp(self):
        ...
        self.new_account = Account("Eric","ricky","0717535957","gicheric14@gmail.com") # create Account object
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_account.account_name,"Eric")
        self.assertEqual(self.new_account.user_name,"ricky")
        self.assertEqual(self.new_account.password,"0717535957")
        self.assertEqual(self.new_account.email,"gicheric14@gmail.com")
    ...
    def test_find_account_by_account_name(self):
        ...
        self.new_account.save_account()
        test_account = Account("Eric","ricky","0717535957","gicheri14@gmail.com") # new account
        test_account.save_account()
