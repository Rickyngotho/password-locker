...
class TestCredentials(unittest.TestCase):
    def setUp(self):
        ...
        self.new_credentials = Credentials("Eric","ricky","0717535957","gicheric14@gmail.com") # create Account object
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_credentials.credentials_name,"Eric")
        self.assertEqual(self.new_credentials.usr_name,"ricky")
        self.assertEqual(self.new_credentials.password,"0717535957")
        self.assertEqual(self.new_credentials.email,"gicheric14@gmail.com")
    ...
    def test_find_credentials_by_credentials_name(self):
        ...
        self.new_credentials.save_credentials()
        test_credentials = Credentials("Test","user","0717535957","test@user.com") # new account
        test_credentials.save_credentials()
    ...
    def test_credentials_exists(self):
        ...
        credentials_exists = Credentials.credentials_exist("0717535957")
